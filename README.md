...
...
	...
	Mirivan: показать себя любимого или окружающее в звонке? Трансляция экрана есть в звонке? Если нет - без пояснения тогда, а иначе - вполне всё логично. Медиа в фоне - голосовые или музыка, запись разговоров (? а ты точно думаешь что она закодена? Сам я не проводил деобфускации и тут без комментариев).
